...
- M. Parasar et al., ["DRAIN: Deadlock Removal for arbitrary irregular networks,"](https://doi.org/10.1109/hpca47549.2020.00044) HPCA 2020.
- J. Yin et al., ["Modular routing design for chiplet-based systems,"](https://doi.org/10.1109/isca.2018.00066) ISCA 2018.
- Y. Wu et al., ["Upward packet popup for deadlock freedom in Modular chiplet-based systems,"](https://doi.org/10.1109/hpca53966.2022.00076) HPCA 2022.
- E. Taheri, S. Pasricha, and M. Nikdast, ["DeFT: A deadlock-free and fault-tolerant routing algorithm for 2.5D chiplet networks,"](https://doi.org/10.23919/date54114.2022.9774617) DATE 2022.

## Tech Stack

- **Language:** Python
- **Model:** Cycle-accurate discrete-event style simulation of a 4×4 active interposer mesh with wormhole flow control

## Getting Started

> Update this section with your actual entry point / scripts once added to the repo.
...
# Run a synthetic-traffic sweep comparing routing scenarios
python simulate.py --mode drain --routing adaptive --injection-rate 0.02
```

## Citation

If you build on this work, please cite the original DRAIN paper:

```
M. Parasar et al., "DRAIN: Deadlock Removal for arbitrary irregular networks,"
2020 IEEE International Symposium on High Performance Computer Architecture (HPCA),
pp. 447-460, Feb. 2020. doi:10.1109/hpca47549.2020.00044
```
